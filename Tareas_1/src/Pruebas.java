...
public class Pruebas<E> {   //La E porque quiero que sea 
	...
	public Pruebas(E[] valores) {                                 //Crea una nueva lista con los valores que tiene el arreglo que le pase
...
//------------------------------------------------------------------------------------------------------------------------------MAIN
	public static void main(String[] args) {       
		...
		Pruebas<Integer> lista = new Pruebas<>(arreglo);
