...
public class MyListaEnlazada<E> {
	...
	protected MyNodo<E> first,   //El unico requisito es este, first 
			            last;
...
//------------------------------------------------------------------------------------------------------------------- Repaso
	...
	public void desplazarLista(int pos) {       //Desplazar pos lugares hacia la izquierda
		...
		/*
		//Implementacion con funciones y variables predeterminadas
		MyNodo<E> current = this.first,
...
//------------------------------------------------------------------------------------------------------------------ MAIN
	public static void main(String[] args) {
		...
		*/
		...
		/*
		Integer[] arr = {};
		MyListaEnlazada<Integer> lista = new MyListaEnlazada<>(arr);
		
		System.out.println(lista);
		lista.insertAt(0, 100);
		System.out.println(lista);
		System.out.println(lista.first);
		
		Integer res = lista.removeAt(2);
